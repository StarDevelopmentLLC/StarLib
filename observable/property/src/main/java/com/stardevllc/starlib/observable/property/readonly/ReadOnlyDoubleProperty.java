...
public class ReadOnlyDoubleProperty extends ReadOnlyNumberProperty implements ObservableDoubleValue {

    protected double value;

    protected ObservableDoubleValue observable = null;

    public ReadOnlyDoubleProperty() {
        this(DEFAULT_BEAN, DEFAULT_NAME);
    }

    public ReadOnlyDoubleProperty(double initialValue) {
    ...
    public ReadOnlyDoubleProperty(Object bean, String name, double initialValue) {
        this(bean, name);
