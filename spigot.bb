...
[URL='https://github.com/StarDevelopmentLLC/StarLib/blob/main/src/main/java/com/stardevllc/starlib/time/TimeUnit.java']Duration [/URL]- This class just allows you to do arithmetic operations using the TimeUnit class without having to convert it yourself all the time. Floating Point precision is lost though as the base value is a long.
