...
package com.stardevllc.starlib.tree;
...
public abstract class TreeNode<T> implements Iterable<TreeNode<T>>, Serializable, Cloneable {
    ...
    public TreeNode<T> find(final T data) {
        ...
        traversePreOrder(new TraversalAction<>() {
            @Override
    ...
    public long size() {
        ...
        final long[] count = {0};
        TraversalAction<TreeNode<T>> action = new TraversalAction<>() {
            @Override
            public void perform(TreeNode<T> node) {
                count[0]++;
            }
    ...
    public String toString() {
        ...
        TraversalAction<TreeNode<T>> action = new TraversalAction<>() {
            ...
            public void perform(TreeNode<T> node) {
                ...
                builder.append("|  ".repeat(Math.max(0, nodeLevel)));
                builder
                        .append("+- ")
                        .append(node.data())
                        .append("\n");
     ...
     * {@link #iterator()}
     */
    public abstract class TreeNodeIterator implements Iterator<TreeNode<T>> {
