...
public class LinkedListTreeTable<R extends Comparable<R>, C extends Comparable<C>, V> extends TreeTable<R, C, List<V>> implements ListTable<R, C, V> {
    ...
    protected class Elements extends AbstractCollection<V> {
        ...
        @Override
        public int size() {
            return LinkedListTreeTable.this.size();
        }
    }
}
