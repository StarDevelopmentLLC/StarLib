...
public class LongRegistry<V> extends Registry<Long, V> {
    ...
    public static class Builder<V> extends Registry.Builder<Long, V> {
        @Override
        public LongRegistry.Builder<V> initialObjects(TreeMap<Long, V> objects) {
            return (LongRegistry.Builder<V>) super.initialObjects(objects);
        }

        @Override
        public  LongRegistry.Builder<V> keyNormalizer(KeyNormalizer<Long> keyNormalizer) {
            return (LongRegistry.Builder<V>) super.keyNormalizer(keyNormalizer);
        }

        @Override
        public  LongRegistry.Builder<V> keyRetriever(KeyRetriever<V, Long> keyRetriever) {
            return (LongRegistry.Builder<V>) super.keyRetriever(keyRetriever);
        }

        @Override
        public  LongRegistry.Builder<V> keyGenerator(KeyGenerator<V, Long> keyGenerator) {
            return (LongRegistry.Builder<V>) super.keyGenerator(keyGenerator);
        }
