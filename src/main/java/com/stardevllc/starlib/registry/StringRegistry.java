...
public class StringRegistry<V> extends Registry<String, V> {
    ...
    public static class Builder<V> extends Registry.Builder<String, V> {
        @Override
        public StringRegistry.Builder<V> initialObjects(TreeMap<String, V> objects) {
            return (StringRegistry.Builder<V>) super.initialObjects(objects);
        }

        @Override
        public  StringRegistry.Builder<V> keyNormalizer(KeyNormalizer<String> keyNormalizer) {
            return (StringRegistry.Builder<V>) super.keyNormalizer(keyNormalizer);
        }

        @Override
        public  StringRegistry.Builder<V> keyRetriever(KeyRetriever<V, String> keyRetriever) {
            return (StringRegistry.Builder<V>) super.keyRetriever(keyRetriever);
        }

        @Override
        public  StringRegistry.Builder<V> keyGenerator(KeyGenerator<V, String> keyGenerator) {
            return (StringRegistry.Builder<V>) super.keyGenerator(keyGenerator);
        }
